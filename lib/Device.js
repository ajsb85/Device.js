...
function _detectDeviceSpec(userAgent, // @arg UserAgentString:
    ...
    if ( /Android/.test(userAgent) ) {
        ...
        os      = "Windows Phone";
        device  = _getWindowsPhoneDevice(userAgent, emulate);
        catalog = DEVICE_CATALOG[device.id];
    }
    if (catalog) {
...
// http://en.wikipedia.org/wiki/List_of_Windows_Phone_7_devices
    "Allegro":          [ACER,     MSM8255,   750,750,  480,800,  259,  0,  0.5,  4,     GW3 ],
//  "OneTouchView":     [ALCATEL,  MSM7227,   750,780,  480,800,    0,  0,  0.5,  4,     GW3 ],
    "IS12T":            [FUJITSU,  MSM8655,   750,750,  480,800,    0,  0,  0.5,  4,     GW3 ],
    "Radar":            [HTC,      MSM8255,   750,750,  480,800,  246,  0,  0.5,  4,     GW3 ],
    "P6800":            [HTC,      MSM8255T,  750,750,  480,800,  198,  0,  0.5,  4,     GW3 ], // Titan
    "PI86100":          [HTC,      MSM8255T,  750,750,  480,800,  198,  0,  0.5,  4,     GW3L], // Titan II
    "Lumia 510":        [NOKIA,    MSM7227,   750,750,  480,800,    0,  0,  0.25, 4,     GW3 ],
    "Lumia 610":        [NOKIA,    MSM7227,   750,750,  480,800,    0,  0,  0.25, 4,     GW3 ],
    "Lumia 710":        [NOKIA,    MSM8255,   750,750,  480,800,    0,  0,  0.5,  4,     GW3 ],
    "Lumia 800":        [NOKIA,    MSM8255,   750,750,  480,800,    0,  0,  0.5,  4,     GW3 ],
    "Lumia 900":        [NOKIA,    APQ8055,   750,750,  480,800,    0,  0,  0.5,  4,     GW3 ],
    "SGH-i667":         [SAMSUNG,  MSM8255T,  750,750,  480,800,  233,  0,  0.5,  4,     GW3 ], // Focus 2
    "SGH-i937":         [SAMSUNG,  MSM8255,   750,750,  480,800,  217,  0,  0.5,  4,     GW3 ], // Focus S
    "GT-S7530":         [SAMSUNG,  MSM7227,   750,750,  480,800,  233,  0,  0.375,4,     GW3 ], // Omnia M
    "GT-I8350":         [SAMSUNG,  MSM8255,   750,750,  480,800,  252,  0,  0.5,  4,     GW3 ], // Omnia W
    "Orbit":            [ZTE,      MSM7227,   750,750,  480,800,  233,  0,  0.5,  4,     GW3 ],
    "Tania":            [ZTE,      MSM8255,   750,750,  480,800,  217,  0,  0.5,  4,     GW3 ],
 */
// --- Windows Phone 8 ---
// http://en.wikipedia.org/wiki/List_of_Windows_Phone_8_devices
    "8S":               [HTC,      MSM8627,   800,800,  480,800,    0,  0,  0.5,  4,     GW3 ],
    "8X":               [HTC,      MSM8960,   800,800,  720,1280, 342,  0,    1,  4,    NGW3 ],
    "8XT":              [HTC,      MSM8930,   800,800,  480,800,    0,  0,    1,  4,    NGW3 ],
    "W1-U00":           [HUAWEI,   MSM8230,   800,800,  480,800,    0,  0,  0.5,  4,     GW3 ], // Ascend W1
    "W2-U00":           [HUAWEI,   MSM8230,   800,800,  480,800,    0,  0,  0.5,  4,     GW3 ], // Ascend W2
    "Lumia 520":        [NOKIA,    MSM8227,   800,800,  480,800,  235,  0,  0.5,  4,     GW3 ],
    "Lumia 525":        [NOKIA,    MSM8227,   800,800,  480,800,  235,  0,    1,  4,     GW3 ],
    "Lumia 620":        [NOKIA,    MSM8960,   800,800,  480,800,  246,  0,  0.5,  4,    NGW3 ],
    "Lumia 625":        [NOKIA,    MSM8930,   800,800,  480,800,  201,  0,  0.5,  4,     GW3L],
    "Lumia 720":        [NOKIA,    MSM8227,   800,800,  480,800,  217,  0,  0.5,  4,    NGW3 ],
    "Lumia 810":        [NOKIA,    MSM8260A,  800,800,  480,800,  217,  0,  0.5,  4,    NGW3 ],
    "Lumia 820":        [NOKIA,    MSM8960,   800,800,  480,800,  217,  0,    1,  4,    NGW3L],
    "Lumia 822":        [NOKIA,    MSM8960,   800,800,  480,800,  217,  0,    1,  4,    NGW3L],
    "Lumia 920":        [NOKIA,    MSM8960,   800,800,  768,1280, 334,  0,    1,  4,    NGW3L],
    "Lumia 925":        [NOKIA,    MSM8960,   800,800,  768,1280, 334,  0,    1,  4,    NGW3L],
    "Lumia 928":        [NOKIA,    MSM8960,   800,800,  768,1280, 334,  0,    1,  4,    NGW3L],
    "Lumia 1020":       [NOKIA,    MSM8960,   800,800,  768,1280, 334,  0,    2,  4,    NGW3L],
    "Lumia 1320":       [NOKIA,    MSM8930,   800,800,  768,1280, 245,  0,    1,  4,     GW3L], // SoC 8930AB -> MSM8930
    "Lumia 1520":       [NOKIA,    MSM8974,   800,800, 1080,1920, 367,  0,    2,  4,    NGW3L], // SoC 8974AA -> MSM8974
    "GT-I8750":         [SAMSUNG,  MSM8960,   800,800,  720,1280, 306,  0,    1,  4,    NGW3 ], // ATIV S
    "SGH-T899M":        [SAMSUNG,  MSM8960,   800,800,  720,1280, 306,  0,    1,  4,    NGW3 ], // ATIV S
    "SPH-I800":         [SAMSUNG,  MSM8930,   800,800,  720,1280, 308,  0,    1,  4,    NGW3L], // ATIV S Neo, SoC MSM8930AA -> MSM8930
    "SCH-I930":         [SAMSUNG,  MSM8960,   800,800,  480,800,  233,  0,    1,  4,    NGW3L], // ATIV Odyssey
};
