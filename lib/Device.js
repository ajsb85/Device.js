...
Device["merge"]   = Device_merge;   // Device.merge(name:String, data:Object):void
...
function Device_merge(name,   // @arg String: "DEVICE" or "SOC"
                      data) { // @arg Object:
//{@assert
    _if(!name || typeof name !== "string", "invalid Device.merge(name,): " + name);
    _if(!data || data.constructor !== ({}).constructor, "invalid Device.merge(,data)");
//}@assert

    var object = Device_catalog(name);
...
function Device_catalog(name) { // @arg String: "DEVICE" or "SOC"
                                ...
                                // @help: Device.catalog
//{@assert
    _if(!name || typeof name !== "string", "invalid Device.catalog(name): " + name);
//}@assert
