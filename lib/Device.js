...
function _applyDeviceData(id,     // @arg String: DEVICE ID
    ...
    var soc  = SOC_CATALOG[ SOC_ID[ data[2] ] ];
    ...
    DEVICE["BRAND"]  = DEVICE_BRAND[ data[1] ];
    DEVICE["SOC"]    = SOC_ID[ data[2] ];
    DEVICE["GPS"]    = /GPS/.test( DEVICE_FUNCTIONS[ data[12] ] );
    OS["TYPE"]       = OS_TYPE[ data[0] ];
    CPU["TYPE"]      = CPU_TYPE[ soc[0] ];
    CPU["CLOCK"]     = soc[1];
    CPU["CORES"]     = soc[2];
    CPU["SIMD"]      = GPU_TYPE[ soc[3] ] !== "Tegra2"; // Tegra2 NEON unsupported
    GPU["TYPE"]      = GPU_TYPE[ soc[3] ];
    GPU["ID"]        = soc[4];
    ...
    NETWORK["3G"]    = /3G/.test(  DEVICE_FUNCTIONS[ data[12] ]);
    NETWORK["LTE"]   = /LTE/.test( DEVICE_FUNCTIONS[ data[12] ]);
    NETWORK["NFC"]   = /NFC/.test( DEVICE_FUNCTIONS[ data[12] ]);
    NETWORK["WIFI"]  = /WIFI/.test(DEVICE_FUNCTIONS[ data[12] ]);

    var pre     = OS_VERSION[ data[3] ].split(".");
    var highest = OS_VERSION[ data[4] ].split(".");
...
// --- OS TYPE ---
var IOS         = 1; // "iOS"
var ANDROID     = 2; // "Android"
var WPHONE      = 3; // "Windows Phone"
var GAME        = 4; // "Game"

var OS_TYPE = {
        1: "iOS", 2: "Android", 3: "Windows Phone", 4: "Game"
    };

// --- Device Brand / Maker ---
var APPLE       =  1; // "Apple"
var GOOGLE      =  2; // "Google"
var MICROSOFT   =  3; // "MicroSoft"
var NINTENDO    =  4; // "Nintendo"
var SONY        =  5; // "SONY"
var SHARP       = 10; // "SHARP"
var FUJITSU     = 11; // "Fujitsu"
var NEC         = 12; // "NEC"
var PANASONIC   = 13; // "Panasonic"
var TOSHIBA     = 14; // "TOSHIBA"
var KYOCERA     = 15; // "Kyocera",
var CASIO       = 16; // "CASIO"
var DELL        = 20; // "DELL"
var ACER        = 21; // "Acer"
var NOKIA       = 22; // "Nokia"
var SAMSUNG     = 30; // "Samsung"
var HUAWEI      = 31; // "Huawei"
var PANTECH     = 32; // "Pantech"
var LG          = 33; // "LG"
var HTC         = 34; // "HTC"
var ZTE         = 35; // "ZTE"
var MOTOROLA    = 36; // "Motorola"

var DEVICE_BRAND = {
         1: "Apple",     2: "Google",    3: "MicroSoft", 4: "Nintendo",
         5: "SONY",
        10: "SHARP",    11: "Fujitsu",  12: "NEC",      13: "Panasonic", 14: "TOSHIBA",
        15: "Kyocera",  16: "CASIO",
        20: "DELL",     21: "Acer",     22: "Nokia",
        30: "Samsung",  31: "Huawei",   32: "Pantech",  33: "LG",        34: "HTC",
        35: "ZTE",      36: "Motorola"
    };
...
var K3V2        = 26; // "K3V2";
var K3V2T       = 27; // "K3V2T";
var OMAP3630    = 30; // "OMAP3630";
var OMAP4430    = 31; // "OMAP4430";
var OMAP4460    = 32; // "OMAP4460";
var S5PC100     = 40; // "S5PC100";
var S5PC110     = 41; // "S5PC110";
var S5L8900     = 42; // "S5L8900";
var EXYNOS4210  = 43; // "Exynos4210";
var EXYNOS4412  = 44; // "Exynos4412";
var EXYNOS5250  = 45; // "Exynos5250";
var QSD8250     = 50; // "QSD8250";
var QSD8650     = 51; // "QSD8650";
var APQ8055     = 52; // "APQ8055";
var APQ8060     = 53; // "APQ8060";
var APQ8064     = 54; // "APQ8064";
var APQ8064T    = 55; // "APQ8064T";
var APQ8074     = 56; // "APQ8074";
var MSM7227     = 70; // "MSM7227";
var MSM7230     = 71; // "MSM7230";
var MSM8225     = 72; // "MSM8225";
var MSM8227     = 73; // "MSM8227";
var MSM8230     = 74; // "MSM8230";
var MSM8255     = 75; // "MSM8255";
var MSM8255T    = 76; // "MSM8255T";
var MSM8260     = 77; // "MSM8260";
var MSM8260A    = 78; // "MSM8260A";
var MSM8627     = 79; // "MSM8627";
var MSM8655     = 80; // "MSM8655";
var MSM8660     = 81; // "MSM8660";
var MSM8660A    = 82; // "MSM8660A";
var MSM8930     = 83; // "MSM8930";
var MSM8960     = 84; // "MSM8960";
var MSM8974     = 85; // "MSM8974";
var MSM8974AB   = 86; // "MSM8974AB";
var HIGHSPEC    = 98; // "HighSpec";  // HighSpec Game Console
var LOWSPEC     = 99; // "LowSpec";   // LowSpec Game Console

var SOC_ID = {
         1: "A4",        2: "A5",        3: "A5X",       4: "A6",          5: "A6X",
         6: "A7",
        20: "T20",      21: "T30L",     22: "AP25H",    23: "AP33",       24: "AP37",
        25: "APE5R",    26: "K3V2",     27: "K3V2T",
        30: "OMAP3630", 31: "OMAP4430", 32: "OMAP4460",
        40: "S5PC100",  41: "S5PC110",  42: "S5L8900",  43: "Exynos4210", 44: "Exynos4412",
        45: "Exynos5250",
        50: "QSD8250",  51: "QSD8650",  52: "APQ8055",  53: "APQ8060",    54: "APQ8064",
        55: "APQ8064T", 56: "APQ8074",
        70: "MSM7227",  71: "MSM7230",  72: "MSM8225",  73: "MSM8227",    74: "MSM8230",
        75: "MSM8255",  76: "MSM8255T", 77: "MSM8260",  78: "MSM8260A",   79: "MSM8627",
        80: "MSM8655",  81: "MSM8660",  82: "MSM8660A", 83: "MSM8930",    84: "MSM8960",
        85: "MSM8974",  86: "MSM8974AB",
        98: "HighSpec", 99: "LowSpec"
    };
...
var TEGRA       = 2; // "Tegra";
var TEGRA2      = 3; // "Tegra2";
var POWERVR     = 4; // "PowerVR";
var MALI        = 5; // "Mali";
var IMMERSION   = 6; // "Immersion";
var GPU_TYPE = {
        1: "Adreno", 2: "Tegra", 3: "Tegra2", 4: "PowerVR", 5: "Mali", 6: "Immersion"
    };
...
var ATOM        = 3; // "ATOM";
var CPU_TYPE = {
        1: "ARM", 2: "ARM64", 3: "ATOM"
    };

// --- NFC, GPS, WiFi, 3G, LTE ---
var NGW3L       = 1; // "NFC_GPS_WIFI_3G_LTE";
var NGW3        = 2; // "NFC_GPS_WIFI_3G";
var NGW         = 3; // "NFC_GPS_WIFI";
var GW3L        = 4; // "GPS_WIFI_3G_LTE";
var GW3         = 5; // "GPS_WIFI_3G";
var G3L         = 6; // "GPS_3G_LTE";
var GW          = 7; // "GPS_WIFI";
var W           = 8; // "WIFI";
var DEVICE_FUNCTIONS = {
        1: "NFC_GPS_WIFI_3G_LTE",
        2: "NFC_GPS_WIFI_3G",
        3: "NFC_GPS_WIFI",
        4: "GPS_WIFI_3G_LTE",
        5: "GPS_WIFI_3G",
...
var OS_VERSION = {
        ...
        230: "2.3.0", 232: "2.3.2", 233: "2.3.3", 234: "2.3.4", 235: "2.3.5", 236: "2.3.6", 237: "2.3.7",
        300: "3.0.0",
        310: "3.1.0",
        320: "3.2.0",
        400: "4.0.0", 401: "4.0.1", 403: "4.0.3", 404: "4.0.4",
        410: "4.1.0", 411: "4.1.1", 412: "4.1.2",
        420: "4.2.0", 421: "4.2.1", 422: "4.2.2",
        430: "4.3.0", 433: "4.3.3",
        440: "4.4.0",
        510: "5.1.0", 511: "5.1.1",
        600: "6.0.0",
...
//  "SO-03F":           [ANDROID,  SONY,     MSM8974AB, v442,v442, 1080,1920,   0,  0, 3072,  5,   5.2, NGW3L], // Xperia Z2 (Sirius)
    ...
    "N-07D":            [ANDROID,  NEC,      MSM8960,   v404,v404,  720,1280, 342,  0, 1024,  5,   4.3,  GW3L],
...
// --- SoftBank ---
  ...
  //"SBM303SH":         [ANDROID,  SHARP,    MSM8974,   v422,v422, 1080,1920,   0,  0, 2048,  5,   4.5, NGW3L], // AQUOS PHONE Xx mini 303SH
    ...
    "301F":             [ANDROID,  FUJITSU,  MSM8974,   v422,v422, 1080,1920,   0,  0, 2048,  2,     5,  GW3L],
    "SBM302SH":         [ANDROID,  SHARP,    MSM8974,   v422,v422, 1080,1920,   0,  0, 2048,  5,   5.2, NGW3L],
//  "EM01L":            [ANDROID,  GOOGLE,   MSM8974,   v440,v440, 1080,1920, 445,  3, 2048,  5,     5,  GW3 ], // E-Mobile Nexus 5 EM01L
    ...
    "SBM203SH":         [ANDROID,  SHARP,    APQ8064,   v412,v412,  720,1280,   0,  0, 2048,  2,   4.9,  GW3 ],
    "201F":             [ANDROID,  FUJITSU,  APQ8064,   v412,v412,  720,1280,   0,  0, 2048,  2,   4.7,  GW3 ],
    "201K":             [ANDROID,  KYOCERA,  MSM8960,   v412,v412,  480,800,    0,  0, 1024,  2,   3.7,  GW3 ],
    "SBM200SH":         [ANDROID,  SHARP,    MSM8960,   v404,v410,  720,1280,   0,  0, 1024,  2,   4.5,  GW3 ],
