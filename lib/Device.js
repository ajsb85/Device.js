...
Device["token"] = Device_token; // Device.token(userAgent:String):DeviceTokenString
Device["spec"]  = Device_spec;  // Device.spec(token):DeviceSpecObject
...
function Device_spec(token) { // @arg DeviceTokenString: device token.
                              ...
                              //        },
                              //        OS: {
                              //           TYPE:    String(= ""): "Android" or "iOS" or "WindowsPhone", "FirefoxOS" or "Tizen"
                              //           VERSION: {
                              ...
                              //        },
                              //        CPU: {
                              //           TYPE:    String(= ""): "ARM", "ATOM"
                              //           CLOCK:   Number(= 0): CPU base clock(unit: GHz). eg: 1.7
                              ...
                              //           ROM:     Integer: Flash ROM size (unit: GB). [[RESERVED]]
                              //        },
                              //        DISPLAY: {
                              ...
                              // @help: Device.spec
//{@assert
    _if(!token || typeof token !== "string", "invalid Device.spec(token)");
//}@assert
...
function Device_token(userAgent) { // @arg String:
                                   // @ret String: device token.
                                   // @help: Device.token

//{@assert
    _if(!userAgent || typeof userAgent !== "string", "invalid Device.token(userAgent)");
//}@assert
...
function _getiOSDeviceToken(userAgent) { // @arg String:
    ...
    var longEdge = Math.max(global["innerWidth"]  || 0,
...
// --- Tegra --- http://en.wikipedia.org/wiki/Tegra
    "T30L":       [ARM,  1.3,  4,     TEGRA3,   "T30L",         ],
    "AP37":       [ARM,  1.7,  4,     TEGRA3,   "AP37",         ],
    "AP33":       [ARM,  1.5,  4,     TEGRA3,   "AP33",         ],
